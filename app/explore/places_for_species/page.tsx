                  ...
                  <React.Fragment key={r.site_id}>
                    <tr onClick={() => toggleSiteWeeks(r.site_id)} style={{ borderBottom: '1px solid #eee', cursor: 'pointer', backgroundColor: isOpen ? '#f9f9f9' : 'white' }}>
                      ...
                      <td style={{ padding: '12px 4px', fontWeight: 'bold', color: '#333' }}>
                        ...
                        <Link
                          href={`/places?site_id=${r.site_id}`}
                          title="Open in Places"
                          style={infoBtnStyle}
                          onClick={(e) => {
                            e.stopPropagation()
                          }}
                      ...
                      <td style={{ padding: '12px 4px', textAlign: 'center' }}>
                        <span style={{ ...badgeStyle, backgroundColor: getLikelihoodColor(r.avg_likelihood_see) }}>{Math.round(r.avg_likelihood_see * 100)}%</span>
                      </td>

                      <td style={{ padding: '12px 4px', textAlign: 'center' }}>
                        <span style={{ ...badgeStyle, backgroundColor: getIntegrityColor(intScore) }}>{intScore ?? '--'}</span>
                      </td>
                    </tr>
                          ...
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                            ...
                            <div style={{ display: 'flex', gap: '4px' }}>
                              <button
                                onClick={(e) => {
                                  e.stopPropagation()
                                  fetchWeeksForSite(r.site_id, 'best')
                                }}
                                style={{
                                  padding: '4px 8px',
                                  fontSize: '10px',
                              ...
                              <button
                                onClick={(e) => {
                                  e.stopPropagation()
                                  fetchWeeksForSite(r.site_id, 'calendar')
                                }}
                                style={{
                                  padding: '4px 8px',
                                  fontSize: '10px',
